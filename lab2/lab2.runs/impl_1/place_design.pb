...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.452 . Memory (MB): peak = 850.371 ; gain = 0.0002default:default
ƒ

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.473 . Memory (MB): peak = 850.371 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.478 . Memory (MB): peak = 850.371 ; gain = 0.0002default:default
h

Phase %s%s
101*constraints2
...
%s
*constraints2r
^Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.997 . Memory (MB): peak = 850.371 ; gain = 0.0002default:default
|

Phase %s%s
101*constraints2
...
%s
*constraints2n
ZTime (s): cpu = 00:00:00 ; elapsed = 00:00:01 . Memory (MB): peak = 850.371 ; gain = 0.0002default:default
k

Phase %s%s
101*constraints2
...
%s
*constraints2n
ZTime (s): cpu = 00:00:01 ; elapsed = 00:00:03 . Memory (MB): peak = 850.371 ; gain = 0.0002default:default
v

Phase %s%s
101*constraints2
...
C
7Phase 1.1.8.1.1 Build Clock Data | Checksum: 34641c306
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:02 ; elapsed = 00:00:04 . Memory (MB): peak = 851.168 ; gain = 0.7972default:default
B
6Phase 1.1.8.1 Place Init Design | Checksum: 27a6d38b2
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:04 . Memory (MB): peak = 851.168 ; gain = 0.7972default:default
I
=Phase 1.1.8 Build Placer Netlist Model | Checksum: 27a6d38b2
*common
…

%s
...
Q
EPhase 1.1.9.1 Constrain Global/Regional Clocks | Checksum: 27a6d38b2
*common
…

%s
...
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:04 . Memory (MB): peak = 851.168 ; gain = 0.7972default:default
F
:Phase 1.1.9 Constrain Clocks/Macros | Checksum: 27a6d38b2
*common
…

%s
...
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:04 . Memory (MB): peak = 851.168 ; gain = 0.7972default:default
G
;Phase 1.1 Placer Initialization Core | Checksum: 27a6d38b2
*common
…

%s
...
ZTime (s): cpu = 00:00:03 ; elapsed = 00:00:04 . Memory (MB): peak = 851.168 ; gain = 0.7972default:default
@
4Phase 1 Placer Initialization | Checksum: 27a6d38b2
*common
…

%s
...
9
-Phase 2.1 Run Budgeter | Checksum: 312829d3d
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:04 ; elapsed = 00:00:06 . Memory (MB): peak = 853.859 ; gain = 3.4882default:default
;
/Phase 2 Global Placement | Checksum: 2e1d7b89e
*common
…

%s
*constraints2n
ZTime (s): cpu = 00:00:07 ; elapsed = 00:00:08 . Memory (MB): peak = 853.859 ; gain = 3.4882default:default
h

Phase %s%s
101*constraints2
...
G
;Phase 3.1 Commit Multi Column Macros | Checksum: 2e1d7b89e
*common
…

%s
...
I
=Phase 3.2 Commit Most Macros & LUTRAMs | Checksum: 24a7ee80c
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:07 ; elapsed = 00:00:09 . Memory (MB): peak = 862.574 ; gain = 12.2032default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 3.3 Area Swap Optimization | Checksum: 225a2eef5
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:08 ; elapsed = 00:00:09 . Memory (MB): peak = 862.574 ; gain = 12.2032default:default
o

Phase %s%s
101*constraints2
...
B
6Phase 3.4 Timing Path Optimizer | Checksum: 2c8b98b85
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:08 ; elapsed = 00:00:09 . Memory (MB): peak = 863.605 ; gain = 13.2342default:default
z

Phase %s%s
101*constraints2
...
M
APhase 3.5 Commit Small Macros & Core Logic | Checksum: 29f0bc092
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:08 ; elapsed = 00:00:10 . Memory (MB): peak = 864.117 ; gain = 13.7462default:default
l

Phase %s%s
101*constraints2
...
?
3Phase 3.6 Re-assign LUT pins | Checksum: 29f0bc092
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:10 . Memory (MB): peak = 864.129 ; gain = 13.7582default:default
;
/Phase 3 Detail Placement | Checksum: 29f0bc092
*common
†

%s
...
@
4Phase 4.1 PCOPT Shape updates | Checksum: 23d088641
*common
†

%s
...
Q
EPhase 4.2.1 Post Placement Timing Optimization | Checksum: 1f8ef6402
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:09 ; elapsed = 00:00:11 . Memory (MB): peak = 865.043 ; gain = 14.6722default:default
H
<Phase 4.2 Post Placement Optimization | Checksum: 1f8ef6402
*common
†

%s
...
C
7Phase 4.3 Post Placement Cleanup | Checksum: 1f8ef6402
*common
†

%s
...
C
7Phase 4.4.1 Congestion Reporting | Checksum: 1f8ef6402
*common
†

%s
...
A
5Phase 4.4.2 updateTiming final | Checksum: 268689902
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:10 ; elapsed = 00:00:11 . Memory (MB): peak = 865.117 ; gain = 14.7462default:default
p

Phase %s%s
101*constraints2
...
C
7Phase 4.4.3 Dump Critical Paths  | Checksum: 268689902
*common
†

%s
...
:
.Phase 4.4.4 Restore STA | Checksum: 268689902
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:10 ; elapsed = 00:00:12 . Memory (MB): peak = 865.117 ; gain = 14.7462default:default
k

Phase %s%s
101*constraints2
...
2*	placeflow20
| WNS=13.268 | TNS=0.000  |
2default:defaultZ30-100
>
2Phase 4.4.5 Print Final WNS | Checksum: 268689902
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:11 ; elapsed = 00:00:12 . Memory (MB): peak = 865.117 ; gain = 14.7462default:default
=
1Phase 4.4 Placer Reporting | Checksum: 268689902
*common
†

%s
...
D
8Phase 4.5 Final Placement Cleanup | Checksum: 251dab126
*common
†

%s
...
[Time (s): cpu = 00:00:11 ; elapsed = 00:00:12 . Memory (MB): peak = 865.117 ; gain = 14.7462default:default
S
GPhase 4 Post Placement Optimization and Clean-Up | Checksum: 251dab126
*common
†

%s
...
[Time (s): cpu = 00:00:11 ; elapsed = 00:00:12 . Memory (MB): peak = 865.117 ; gain = 14.7462default:default
5
)Ending Placer Task | Checksum: 1561388f1
*common
†

%s
*constraints2o
[Time (s): cpu = 00:00:00 ; elapsed = 00:00:12 . Memory (MB): peak = 865.117 ; gain = 14.7462default:default
Q
Releasing license: %s
83*common2"
...
865.1172default:default2
16.9612default:defaultZ17-268
^
...

sreport_utilization: Time (s): cpu = 00:00:00 ; elapsed = 00:00:00.157 . Memory (MB): peak = 872.832 ; gain = 0.000
*common
j
...
00:00:00.3972default:default2
872.8322default:default2
0.0002default:defaultZ17-268

